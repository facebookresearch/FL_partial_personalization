...
do
    ...
    name="so_${arch_size}_${train_mode}_${l2}_${pfl_algo}_pretrained_lr${client_lr}_slr1e-2_val"
...
do
    name="so_${arch_size}_${train_mode}_${hidden_dim}_${pfl_algo}_pretrained_lr${client_lr}_slr1e-2_val"
