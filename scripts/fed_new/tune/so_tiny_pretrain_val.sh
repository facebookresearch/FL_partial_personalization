...
common_args="${common_args} --clip_grad_norm  --log_test_every_n_rounds 100 --max_num_clients_for_logging 100 "  # TODO!
common_args="${common_args} --arch_size ${arch_size} --pfl_algo fedavg \
        --server_optimizer adam --server_lr 1e-2 --client_scheduler const --client_lr 10 \
...
do
    name="so_${arch_size}_pretrain_val"
