...
#SBATCH --array=0-31%11  # TODO: count
#SBATCH --nodes=1
...
for seed in 2 3 4 5
do
for pfl_algo in "pfl_alternating" "pfl_joint"
do
...
do
    ...
    name="so_${arch_size}_${train_mode}_${l2}_${pfl_algo}_pretrained_stateless_seed${seed}"
...
do
    name="so_${arch_size}_${train_mode}_${hidden_dim}_${pfl_algo}_pretrained_stateless_seed${seed}"
