...
do
    name="so_${arch_size}_${train_mode}_${hidden_dim}_${pfl_algo}_do${dropout}_pretrained_stateful_seed${seed}"
    task_params="--personalized_dropout ${dropout} --seed ${seed} --pfl_algo ${pfl_algo} --personalize_on_client ${train_mode} --adapter_hidden_dim ${hidden_dim} --logfilename ${logdir}/${name} --savedir ${savedir}/${name}"
