...
common_args="${common_args} --num_communication_rounds 1000 --num_clients_per_round 50 --num_local_epochs 1"
...
common_args="${common_args} --arch_size ${arch_size} \
        --server_optimizer adam --server_lr 5e-4 --client_lr 1 --client_scheduler const \
...
#     name="so_${arch_size}_${train_mode}_${l2}_${pfl_algo}_randinit_stateless_seed${seed}"
...
do
    name="so_${arch_size}_${train_mode}_${hidden_dim}_${pfl_algo}_randinit_stateless_seed${seed}"
