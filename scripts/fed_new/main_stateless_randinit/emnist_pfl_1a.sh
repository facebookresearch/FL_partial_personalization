...
common_args="${common_args}  --client_scheduler const --server_optimizer sgd --server_lr 1.0 --server_momentum 0.0 \
    --client_lr 0.5 --global_scheduler const_and_cut --global_lr_decay_factor 0.5 --global_lr_decay_every 500 \
    --stateless_clients"
...
do
    name="emnist_resnetgn_${train_mode}_${pfl_algo}_randinit_stateless_seed${seed}"
