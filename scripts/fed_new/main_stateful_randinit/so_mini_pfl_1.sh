...
#     name="so_${arch_size}_${train_mode}_${l2}_${pfl_algo}_randinit_stateful_seed${seed}"
...
do
    name="so_${arch_size}_${train_mode}_${hidden_dim}_${pfl_algo}_randinit_stateful_seed${seed}"
